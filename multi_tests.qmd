...
# model bez obserwacji odstającej
...
Analizując wyniki MANOVA, nie należy przyjmować reguły, że wystarczy
istotność dowolnej statystyki testowej. Statystyki Pillai’a, Wilksa,
Hotellinga-Lawleya i Roya są alternatywnymi sposobami testowania tej samej
hipotezy o równości wektorów średnich, a ich rozbieżności należy
interpretować w świetle spełnienia założeń. Ponieważ wcześniej stwierdzono
naruszenie wielowymiarowej normalności, najbezpieczniej oprzeć główny wniosek
na śladzie Pillai’a, który jest zwykle najbardziej odporny na takie
odchylenia. Jeżeli ten test wskazuje istotność, istnieją podstawy do
odrzucenia hipotezy $H_0$ o równości wektorów średnich pomiędzy grupami.
Analiza po wyłączeniu obserwacji odstającej prowadzi do tego samego wniosku,
co zwiększa wiarygodność rezultatu.
