...
$\hat{x}_{i}=\sum_{j=1}^{k} t_{ij} \, w_{j}^\top$, gdzie $t_{ij} = x_i^\top w_j$, co pozwala na analizę błędów
...
Z kryteriów tych wynika algorytm *FastICA* jako iteracyjne poszukiwanie stałego punktu. Dla
